...
st.sidebar.image(head, caption="project on group 54 theis book",use_column_width=True)




st.title("House Pricing prdection ")

menu=["House Prediction","Predicted House","About","Visual"]
choices=st.sidebar.selectbox("Dashboard",menu)
...
if choices=='About':
    ...
    this project bulding our team group 54 jusy
    1:Mohamed Ali ibraahim group leader
    2:bilan abdullahi siciid assisant leader
    3: jihan with  ext book and hassan assisant with jihaan
